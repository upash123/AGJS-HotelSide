...
export default class HotelDatepicker {
	...
	getWeekDayNames() {
		...
		if (this.startOfWeek === 'monday') {
			for (let i = 0; i < 7; i++) {
				week += '<th id = "change_th" class="datepicker__week-name">' + this.lang('day-names-short')[(1 + i) % 7] + '</th>';
			}
		...
		for (let i = 0; i < 7; i++) {
			week += '<th id = "change_th" class="datepicker__week-name">' + this.lang('day-names-short')[i] + '</th>';
		}
	...
	createDatepickerDomString() {
        ...
        // Print single months
		for (let i = 1; i <= 2; i++) {
			html += '<table id="' + this.getMonthTableId(i) + '" class="datepicker__month datepicker__month--month' + i + '"><thead><tr class="datepicker__month-caption"><th class="change_th"><span id = "change_th" class="datepicker__month-button datepicker__month-button--prev" month="' + i + '">&lt;</span></th><th id = "change_th" colspan="5" class="datepicker__month-name"></th><th ><span id = "change_th" class="datepicker__month-button datepicker__month-button--next" month="' + i + '">&gt;</span></th></tr><tr class="datepicker__week-days">' + this.getWeekDayNames(i) + '</tr></thead><tbody></tbody></table>';
		}
