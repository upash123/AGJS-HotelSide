...
var HotelDatepicker = function HotelDatepicker(input, options) {
	...
	this.i18n = opts.i18n || {
		...
		'error-more': '日期區間不得超過一晚', //'Date range should not be more than 1 night'
		'error-more-plural': '日期區間不得超過 %d 晚',//Date range should not be more than %d nights
		'error-less': '日期區間不得少於一晚', //'Date range should not be less than 1 night'
		'error-less-plural': '日期區間不得少於 %d 晚',//Date range should not be less than %d nights
		'info-more': '請選擇至少一晚', //Please select a date range of at least 1 night
		'info-more-plural': '請選擇至少 %d 晚', //Please select a date range of at least %d nights
		'info-range': '請選擇 %d 到 %d 晚',//Please select a date range between %d and %d nights
		'info-default': '請選擇日期區間'//Please select a date range
	};
